...
import uk.gov.hmrc.gform.sharedmodel.formtemplate.{ CsvColumnName, FormComponentId, FormCtx, FormTemplateId, Lookup, Register, Section, SectionNumber, SelectionCriteria, Text, Value }
...
class LookupControllerSpec
  ...
  trait TestFixture {
    ...
    mockAuth
      ...
      (
        _: FormTemplateId, _: Option[AccessCode], _: OperationWithForm, _: Option[SectionNumber], f: Request[
          AnyContent
