...
const urlMatch: RegExpMatchArray | null = url.match(/(.*)\/submissions\/summary\/([^/]*)\/(.*)\?(.*)/);
...
const initiateNote = (summarySection: SummarySection, coordinates: Coordinates | null): void => {
  ...
  if (mainContent !== null) {
    ...
    if (content !== undefined) {
      ...
      render(<NoteControllerComponent noteKind={NoteUpdateKind.SummarySection} noteKindData={coordinates} />, content);
    }
  }
};
