...
sealed trait ExpressionResult extends Product with Serializable {
  ...
  def -(er: ExpressionResult): ExpressionResult = er match {
    ...
    case t: Hidden.type  => this
    case t: Empty.type   => this
    case t: NumberResult => fold[ExpressionResult](identity)(_ => t)(identity)(_ - t)(invalidSubstract)(invalidSubstract)
  ...
  def *(er: ExpressionResult): ExpressionResult = er match {
    // format: off
    case t: Invalid      => t
    case t: Hidden.type  => fold[ExpressionResult](identity)(identity)(identity)(_ => NumberResult(0))(invalidMult)(invalidMult)
    case t: Empty.type   => this
    case t: NumberResult => fold[ExpressionResult](identity)(_ => NumberResult(0))(identity)(_ * t)(invalidMult)(invalidMult)
  ...
  def orElse(er: ExpressionResult): ExpressionResult =
    fold[ExpressionResult](identity)(_ => er)(_ => er)(identity)(identity)(identity)
  ...
  def contains(er: ExpressionResult): Boolean = this match {
    ...
    case t: OptionResult =>
      er.fold[Boolean](_ => false)(_ => false)(_ => false)(n => t.contains(n.value))(_ => false)(_ => false)
  }
  ...
  private def isEmpty: Boolean =
    fold[Boolean](_ => false)(_ => false)(_ => true)(_ => false)(_ => false)(_ => false)
  private def ifNumberResult(f: BigDecimal => Boolean): Boolean =
    fold[Boolean](_ => false)(_ => false)(_ => false)(r => f(r.value))(_ => false)(_ => false)
  private def ifStringResult(f: String => Boolean): Boolean =
    fold[Boolean](_ => false)(_ => false)(_ => false)(_ => false)(r => f(r.value))(_ => false)
