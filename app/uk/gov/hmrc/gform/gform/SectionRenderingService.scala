...
class SectionRenderingService(frontendAppConfig: FrontendAppConfig, lookupRegistry: LookupRegistry) {
  ...
  def renderSection(
    ...
    val renderingInfo = SectionRenderingInformation(
      ...
      sectionNumber,
      page.title.value,
      page.documentTitle.fold(page.title.valueWithoutInterpolations)(_.value()),
  ...
  def renderDeclarationSection(
    ...
    val renderingInfo = SectionRenderingInformation(
      ...
      declarationPage.documentTitle.fold(declarationPage.title.valueWithoutInterpolations)(_.value()),
  ...
  def renderAcknowledgementSection(
    ...
    val renderingInfo = SectionRenderingInformation(
      ...
      destinationList.acknowledgementSection.documentTitle
        .fold(destinationList.acknowledgementSection.title.valueWithoutInterpolations)(_.value()),
