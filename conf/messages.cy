...
generic.positive.whole.sterling.error.required=Nodwch {1}
generic.positive.whole.sterling.error.pattern=Nodwch {1} yn y fformat cywir{2}
generic.positive.whole.sterling.error.pattern.start=Mae {1} yn gorfod bod yn swm o arian{2}
generic.positive.whole.sterling.error.maxdigit.pattern=Mae {1} yn gorfod bod yn 11 digid neu lai{2}
generic.positive.whole.sterling.error.pence.pattern=Mae {1} yn gorfod beidio â chynnwys ceiniogau{2}
generic.positive.whole.sterling.error.positive.pattern=Mae {1} yn gorfod bod yn 0 neu fwy{2}
