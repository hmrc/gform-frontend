...
generic.utr.error.pattern=CHANGE ME Enter {1} Unique Taxpayer Reference in the correct format
generic.utr.error.required=CHANGE ME Enter {1} Unique Taxpayer Reference
