...
generic.nino.error.pattern=CHANGE ME Enter {1} National Insurance number in the correct format
generic.nino.error.required=CHANGE ME Enter {1} National Insurance number
generic.nino.error.required= CHANGE ME Enter {1} National Insurance number
generic.email.error.pattern= CHANGE ME  Enter {1} email address in the correct format, like name@example.com
