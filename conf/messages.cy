...
generic.vrn.error.pattern=CHANGE ME Enter {1} VAT registration number in the correct format
generic.vrn.error.required=CHANGE ME Enter {1} VAT registration number
