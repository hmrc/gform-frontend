...
emailAuth.thisCanTakeFewMins=Gall hyn gymryd ychydig funudau i gyrraedd.
...
addToList.remove.item.header=Dileu eitem
addToList.remove.item.detail=Eitem i’w dileu
...
generic.nino.error.pattern=Nodwch rif Yswiriant Gwladol {1}yn y fformat cywir
generic.nino.error.required=Nodwch rif Yswiriant Gwladol{1}
generic.email.error.pattern=Nodwch gyfeiriad e-bost {1}yn y fformat cywir, megis enw@enghraifft.com
generic.email.error.required=Nodwch gyfeiriad e-bost{1}
generic.auth.email.error.pattern=Nodwch gyfeiriad e-bost yn y fformat cywir, megis enw@enghraifft.com
generic.auth.email.error.required=Nodwch gyfeiriad e-bost
generic.utr.error.pattern=Nodwch Gyfeirnod Unigryw y Trethdalwr {1}yn y fformat cywir
generic.utr.error.required=Nodwch Gyfeirnod Unigryw y Trethdalwr{1}
generic.utr.not.exist=Nid yw Cyfeirnod Unigryw y Trethdalwr a nodwyd yn bodoli
generic.vrn.error.pattern=Nodwch rif cofrestru TAW {1}yn y fformat cywir
generic.vrn.error.required=Nodwch rif cofrestru TAW{1}
generic.vrn.error.digitcheck=Nid yw’r Rhif Cofrestru TAW a nodwyd gennych yn bodoli. Nodwch rif TAW go iawn
generic.paye.error.pattern=Nodwch gyfeirnod TWE {1}yn y fformat cywir
generic.paye.error.required=Nodwch gyfeirnod TWE{1}
generic.eori.error.required=Nodwch rif EORI{1}
generic.eori.error.pattern=Nodwch rif EORI {1}yn y fformat cywir
generic.companyRegistrationNumber.error.required=Nodwch rhif cofrestru’r cwmni{1}
generic.companyRegistrationNumber.error.pattern=Nodwch rhif cofrestru’r cwmni {1}yn y fformat cywir
generic.ukEori.error.required=Nodwch rif EORI{1}
generic.ukEori.error.pattern=Nodwch rif EORI {1}yn y fformat cywir
generic.ukBankAccount.error.required=Nodwch rif cyfrif
generic.ukBankAccount.error.length=Mae rhif y cyfrif yn gorfod bod yn 8 digid
generic.ukBankAccount.error.pattern=Nodwch rif cyfrif dilys, megis 12345678
generic.childBenefitNumber.error.required=Nodwch rif Budd-dal Plant{1}
generic.childBenefitNumber.error.pattern=Nodwch rif Budd-dal Plant {1} yn y fformat cywir
...
generic.referenceNumber.error.required=Nodwch {1}
generic.referenceNumber.error.pattern=Nodwch {1} yn y fformat cywir
...
country.error.lookup=Dim byd yn cyd-fynd â "{1}" - dewiswch wlad o’r rhestr.
...
generic.error.selectOption=Dewiswch yr hyn rydych am ei wneud nawr
...
enrolment.help.contact.telephone.content=0300 200 3705
enrolment.help.contact.textphone=Ffôn testun:
enrolment.help.contact.textphone.content=18001 0300 200 3705
...
generic.error.overseas.line1.maxLength=Mae’n rhaid i linell 1 fod yn {1} o gymeriadau neu lai
generic.error.overseas.line2.maxLength=Mae’n rhaid i linell 2 fod yn {1} o gymeriadau neu lai
generic.error.overseas.line3.maxLength=Mae’n rhaid i linell 3 fod yn {1} o gymeriadau neu lai
...
generic.error.overseas.country.maxLength=Mae’n rhaid i’r wlad fod yn {1} o gymeriadau neu lai
...
overseasAddress.city=Tref neu ddinas {0}
...
overseasAddress.city.label=tref neu ddinas
...
# hmrcTaxPeriod
taxPeriod.noResults.warning=Ni ellir dod o hyd i gyfnodau treth agored ar gyfer y cofrestriad hwn.
...
file.error.filename.invalid=Enw’r ffeil yn annilys
file.error.invalid.extension=Rhaid i’r ffeil a uwchlwythwyd gael yr estyniad cywir o {0}
...
accessCode.downloadAnother=Lawrlwytho copi o {0} arall a gyflwynwyd
accessCode.enter.continue.p1=Bydd angen i chi ddarparu’r cod mynediad perthnasol i barhau i weithio ar {0} a gadwyd yn flaenorol
...
accessCode.new.validFor=Mae’r cod mynediad hwn yn ddilys am 28 diwrnod
accessCode.new.willExpire=Ar ôl i chi gyflwyno’r {0} hon, byddwch yn gallu lawrlwytho copi o’r {0} am {1} diwrnod, ar ôl hynny bydd y cod mynediad yn dod i ben
accessCode.saved.title=Cadwyd eich {0}
accessCode.saved.p1=Eich cod mynediad yw
...
downloadThenNew.table.caption.submittedOn=Wedi’i gyflwyno ar
downloadThenNew.table.value.submittedOn={0} ar {1}
...
submission.receipt=Derbynneb cyflwyniad
...
saUtr.default.helpText=Mae’n 10 rhif, er enghraifft, 1234567890. Bydd i’w weld ar Ffurflenni Treth a llythyrau eraill am Hunanasesiad. Efallai y bydd yn cael ei alw’n ’cyfeirnod’, ’UTR’ neu ’defnydd swyddogol’.
